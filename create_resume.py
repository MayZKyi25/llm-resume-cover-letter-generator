...
job_description = (
    ...
    "machine learning, and cloud platforms. The ideal candidate should have at "
    "least 2 years of experience working with large datasets and building scalable applications."
)
